...
const { createActivity, deleteActivity, getPersonalActivity, getFeedActivity, likeActivity, commentActivity, deleteCommentActivity, addBookmarks } = require("./controller")
...
router.patch("/activity/bookmarks/:postId", isLoginUser, addBookmarks)
